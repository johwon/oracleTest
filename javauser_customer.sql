...
CREATE TABLE PRODUCT(
    NO VARCHAR2(4),
    NAME VARCHAR2(20) NOT NULL,
    CLASSIFIED NUMBER(1), --1=상의 2=하의 3=잡화
    PRICE NUMBER(15) NOT NULL
);
ALTER TABLE PRODUCT MODIFY CLASSIFIED NUMBER(1);
ALTER TABLE PRODUCT MODIFY NAME VARCHAR2(20) NOT NULL;
ALTER TABLE PRODUCT MODIFY PRICE NUMBER(15) NOT NULL;


ALTER TABLE PRODUCT ADD CONSTRAINTS PRODUCT_NO_PK PRIMARY KEY(NO);
INSERT INTO PRODUCT VALUES('0001', '후드집업', 50000,1);
INSERT INTO PRODUCT VALUES('0002', '후드티',  30000,1);
INSERT INTO PRODUCT VALUES('0003', '니트집업', 40000 ,1);
...
--일련번호 생성
SELECT LPAD(COUNT(*)+1,3,'0') AS COUNT FROM PRODUCT WHERE CLASSIFIED =1;
commit;
--시퀀스생성
...
INSERT INTO ORDERS VALUES(ORDERS_SEQ.NEXTVAL, 1, '0003', 1);
DELETE FROM ORDERS;
SELECT * FROM ORDERS;
commit;
...
DROP TRIGGER CUS_POINT_TRIGGER;
