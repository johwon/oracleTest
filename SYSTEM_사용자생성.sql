...
DROP USER FLIGHTRESERVATION CASCADE; -- 기존 사용자 삭제
CREATE USER FLIGHTRESERVATION IDENTIFIED BY 123456 -- 사용자 이름: Model, 비밀번호 : 1234
    DEFAULT TABLESPACE USERS
    TEMPORARY TABLESPACE TEMP; --임시파일 저장장소--
GRANT connect, resource, dba TO FLIGHTRESERVATION; -- 권한 부여
